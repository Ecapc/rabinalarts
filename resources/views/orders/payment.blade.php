<x-app-layout>
    ...
    <div class="grid grid-cols-5 gap-6 container py-8">
        ...
        <div class="col-span-2">
            <div class="bg-blueGray-500 rounded-lg shadow-lg p-6">
                <div class=" text-white flex justify-between items-center ">
                

        
                        <img class="h-8 " src=" {{asset('imgassist/WFlogo.png')}} " alt="">
                        <img class="h-8" src=" {{asset('imgassist/Zellelogo.png')}} " alt="">
                    ...
                    <div>
                        ...
                        <x-button class="content-between ">
                            Seguir 
                        </x-button>
                    </div>
                </div>
